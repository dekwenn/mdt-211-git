...
namespace consoleapp3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            PrintThechoiceofthebrave(decide, flowerStore);
            Console.ReadLine();
        }

        static void PrintSelectFlower(string  decide, FlowerStore flowerStore)
        {
            string selectFlower;
            ...
            Pickflowers(selectFlower, flowerStore);
            PrintThechoiceofthebrave(decide, flowerStore);


        }

        static void Pickflowers(string selectFlower, FlowerStore flowerStore)
        {
            switch (selectFlower)
            {
                case "1":
        ...
        static void PrintThechoiceofthebrave(string decide, FlowerStore flowerStore)
        {
